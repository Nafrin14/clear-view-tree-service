  ...
  return (
    <section className="relative flex min-h-[90vh] items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-20">
        <span className="mb-6 inline-block rounded-full bg-green-800 px-5 py-2 text-sm font-semibold text-white">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Link
            to="/contact"
            className="rounded-xl bg-green-800 px-8 py-4 font-bold text-white transition hover:bg-green-900"
          >
            Get Free Estimate
          </Link>
          ...
          <a
            ...
            className="rounded-xl border-2 border-white px-8 py-4 font-bold text-white transition hover:bg-white hover:text-green-900"
          >
            Call Now
          </a>
        </div>
